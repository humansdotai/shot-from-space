"use client";
/**
 * Vendored from interior[.]dev — https://github.com/ddoemonn/interior
 * Copyright (c) 2026 ozzy. MIT License. Full text: THIRD_PARTY.md
 *
 * These components ship as copy-in files by design: a headless `useX` hook that
 * owns the behaviour and touches no class names, plus a styled example built on
 * it. We keep the hooks as-authored and reskin the styled layer to the Shot
 * from Space shell — which is the reskinning path the library intends.
 */
