...
export const PARTNERS: Partner[] = [
  ...
  {
    id: "skywatch",
    name: "SkyWatch EarthCache",
    sensor: "optical",
    resolution: "0.5–3 m",
    blurb: "Unified pipeline API brokering archive + fresh tasking from many suppliers.",
    noradGroup: "active",
    api: "live",
    site: "https://skywatch.com",
  },
  {
    id: "planet",
    name: "Planet · SkySat",
  ...
  },
  {
    ...
    sensor: "optical",
    resolution: "10 m",
    blurb: "ESA open data — free, revisits every few days. Used for the live basemap.",
    noradGroup: "active",
    api: "live",
